...
public class Park{
	...
	//Takes in Dinosaur object, performs null and maxCapacity checks, creates a new array with size + 1, copies contents of 
	//original array, copies parameter to last spot in array, re-assigns newDinoList to dinoList
	public void addDino(Dinosaur d) {
		Dinosaur[] newDinoList;
		//dinoList null check, if true take dino parameter and insert it into first spot in dinoList array and returns
		if (dinoList == null)
		{
	...
	//toString method that calls on lower level toString() methods to build a String representing park name and contents.
	@Override
	public String toString()
	{
		//Initial message using getName which returns the name of the park to build a string.
		String s = "Welcome to " + getName() + "!\r\n - - - - - - - - - - - - -\n";
		//Cycles through dinoList length amount of times and appends to a string until complete.
		for(int i = 0; i < dinoList.length; i++)
		{
